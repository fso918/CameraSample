...
import com.yyp.mysample.pickerview.lib.WheelTime;
...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
	...
	public TimePopupWindow(Context context, Type type) {
		this(context,type,Model.NONE);
	}

	public TimePopupWindow(Context context, Type type,Model model){
		super(context);
		...
		wheelTime = new WheelTime(timepickerview, type,model);

		wheelTime.screenheight = DisplayUtils.getScreenHeight(context);
